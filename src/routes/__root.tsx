  ...
  head: () => ({
    meta: [
      ...
      { title: "English Hasti — یادگیری انگلیسی با فیلم و سریال" },
      {
        name: "description",
        content:
          "هر روز یک کلیپ کوتاه از فیلم‌های واقعی با دیالوگ انگلیسی، ترجمه دقیق فارسی و توضیح اصطلاحات کاربردی — مستقیم در ایمیل شما.",
      },
      { name: "author", content: "English Hasti" },
      { property: "og:title", content: "English Hasti — یادگیری انگلیسی با فیلم و سریال" },
      {
        property: "og:description",
        content: "یادگیری زبان انگلیسی با کلیپ‌های فیلم و سریال، ترجمه فارسی و توضیح اصطلاحات.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Caveat:wght@500;600;700&family=Vazirmatn:wght@400;500;600;700;800&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
